...
namespace Course.gRPC.Migrations
{
    ...
    [Migration("20220627141939_updatestudentcategory")]
    partial class updatestudentcategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.Core.Models.Courses.StudentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Service.Core.Models.Courses.TeacherSubject", b =>
                {
                    ...
                    b.HasIndex("SubjectId", "SemesterId", "Code", "TeacherId");
            ...
            modelBuilder.Entity("Service.Core.Models.Courses.VideoScript", b =>
                {
                    b.HasBaseType("Service.Core.Models.Courses.SectionScript");

                    b.Property<string>("Description")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("VideoScript_Description");

                    b.Property<string>("Title")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("VideoScript_Title");
                    ...
                    b.HasDiscriminator().HasValue("VideoScript");
                });
            ...
            modelBuilder.Entity("Service.Core.Models.Courses.Student", b =>
                {
                    b.HasOne("Service.Core.Models.Courses.StudentCategory", "Category")
                        .WithMany("Students")
